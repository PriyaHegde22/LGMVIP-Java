...
public class TicTacToe {
	...
	if(b1==1&&b2==1&&b3==1)
	{
		JOptionPane.showMessageDialog(frmTictactoe, " X wins!!!!","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
		cntofx1++;
	...
	{
		JOptionPane.showMessageDialog(frmTictactoe, "O wins!!!!","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
		cntofo1++;
	...
	{
		JOptionPane.showMessageDialog(frmTictactoe, "No one wins!! Draw.. ):","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
	...
	private void initialize() {
		...
		frmTictactoe.setBackground(SystemColor.inactiveCaption);
		frmTictactoe.setFont(new Font("Arial", Font.BOLD, 18));
		frmTictactoe.setTitle("TicTacToe");
		frmTictactoe.setBounds(100, 100, 903, 602);
		...
		btn1.setForeground(SystemColor.desktop);
		...
		btn2.setForeground(SystemColor.desktop);
		...
		btn3.setForeground(SystemColor.desktop);
		...
		lblNewLabel.setBounds(10, 10, 171, 175);
		...
		cntofx.setForeground(new Color(121, 208, 138));
		...
		btn5.setForeground(SystemColor.desktop);
		...
		btn6.setForeground(SystemColor.desktop);
		...
		cntofo.setForeground(new Color(121, 208, 138));
		...
		btn8.setForeground(SystemColor.desktop);
		...
		btn9.setForeground(SystemColor.desktop);
		...
		resetbtn.setForeground(new Color(220, 141, 22));
		resetbtn.setBackground(SystemColor.info);
